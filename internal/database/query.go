...
func CreateRoom(db *sql.DB) (int, error) {
	...
	query := "INSERT INTO ROOMS DEFAULT VALUES RETURNING id"
...
func UserJoinRoom(db *sql.DB, user_id, room_id int) {
	...
	query := "INSERT INTO room_users (user_id, room_id) VALUES ($1,$2) "
...
func InsertMessage(db *sql.DB, user_id, room_id int, message string) {
	...
	query := "INSERT INTO MESSAGES (user_id, room_id,content) VALUES ($1,$2,$3)"
